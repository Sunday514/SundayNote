...
require_source_file "$SOURCE_ROOT/templates/周记录.md"
require_source_file "$SOURCE_ROOT/templates/月记录.md"
...
preflight_local_file "$VAULT_ROOT/个人模板/周记录.md"
preflight_local_file "$VAULT_ROOT/个人模板/月记录.md"
